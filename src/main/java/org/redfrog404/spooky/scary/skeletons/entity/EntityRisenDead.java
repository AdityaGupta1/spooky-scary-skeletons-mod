...
public class EntityRisenDead extends EntityMob {
	/**
	...
	public EntityRisenDead(World worldIn) {
		super(worldIn);
	...
	public void setChild(boolean childZombie) {
		this.getDataWatcher().updateObject(12,
				Byte.valueOf((byte) (childZombie ? 1 : 0)));
	...
	public void onKillEntity(EntityLivingBase entityLivingIn) {
		...
		if ((this.worldObj.getDifficulty() == EnumDifficulty.NORMAL || this.worldObj
			...
			EntityRisenDead entityzombie = new EntityRisenDead(this.worldObj);
	...
	public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_,
		...
		if (p_180482_2_1 == null) {
			p_180482_2_1 = new EntityRisenDead.GroupData(
		...
		if (p_180482_2_1 instanceof EntityRisenDead.GroupData) {
			EntityRisenDead.GroupData groupdata = (EntityRisenDead.GroupData) p_180482_2_1;
	 ...
	 * 
	 * @param isChild
	 *            If the mob is a child it's height and width will be halved.
