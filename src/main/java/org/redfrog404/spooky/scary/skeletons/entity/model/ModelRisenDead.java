...
public class ModelRisenDead extends ModelBiped
{
    public ModelRisenDead()
    {
        this(0.0F, false);
    }

    protected ModelRisenDead(float p_i1167_1_, float p_i1167_2_, int p_i1167_3_, int p_i1167_4_)
    {
        super(p_i1167_1_, p_i1167_2_, p_i1167_3_, p_i1167_4_);
    }

    public ModelRisenDead(float p_i1168_1_, boolean p_i1168_2_)
    {
