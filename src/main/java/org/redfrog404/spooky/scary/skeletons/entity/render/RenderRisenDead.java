...
import org.redfrog404.spooky.scary.skeletons.entity.model.ModelRisenDead;
...
public class RenderRisenDead extends RenderBiped {
	private static final ResourceLocation zombieTextures = new ResourceLocation(
			"spooky:textures/entity/overworld/risen_dead.png");
	...
	public void func_180579_a(EntityRisenDead p_180579_1_, double p_180579_2_,
	...
	protected ResourceLocation func_180578_a(EntityRisenDead p_180578_1_) {
		return p_180578_1_.isVillager() ? zombieVillagerTextures
				: zombieTextures;
	}

	private void func_82427_a(EntityRisenDead p_82427_1_) {
	...
	protected void rotateCorpse(EntityRisenDead p_77043_1_, float p_77043_2_,
	...
	protected ResourceLocation getEntityTexture(EntityLiving entity) {
		return this.func_180578_a((EntityRisenDead) entity);
	}
	...
	public void doRender(EntityLiving entity, double x, double y, double z,
		...
		this.func_180579_a((EntityRisenDead) entity, x, y, z, p_76986_8_,
				partialTicks);
	}

	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		this.rotateCorpse((EntityRisenDead) p_77043_1_, p_77043_2_, p_77043_3_,
				p_77043_4_);
	}
